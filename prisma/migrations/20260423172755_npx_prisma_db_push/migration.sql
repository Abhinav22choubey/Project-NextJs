...
-- CreateIndex
CREATE INDEX "ProfileAnalytics_visitedAt_linkId_idx" ON "ProfileAnalytics"("visitedAt", "linkId");
...
-- AddForeignKey
ALTER TABLE "ProfileAnalytics" ADD CONSTRAINT "ProfileAnalytics_linkId_fkey" FOREIGN KEY ("linkId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
